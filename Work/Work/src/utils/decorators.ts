...
interface IParameterizedPropertyDescriptor extends PropertyDescriptor {
...
export const data: IParameterizedPropertyDescriptor = makeParamsObject()
...
function makeParamsObject(): IParameterizedPropertyDescriptor {
